				...
				<ul class="nav navbar-nav">
						...
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="archvie">Login</a></li>
									<li><a href="archvie">Register</a></li>
								</ul>
							</div>
						</div>
					</li>
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-play-circle-o"></i> Video</a>
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="archvie">Text 201</a></li>
									<li><a href="archvie">Text 202</a></li>
									<li><a href="archvie">Text 203</a></li>
									<li><a href="archvie">Text 204</a></li>
									<li><a href="archvie">Text 205</a></li>
								</ul>
							</div> 
						</div>
					</li>
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-list"></i> Category</a>
						<div class="dropdown-menu" style="margin-left: -203.625px;">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="archvie">Text 301</a></li>
									<li><a href="archvie">Text 302</a></li>
									<li><a href="archvie">Text 303</a></li>
									<li><a href="archvie">Text 304</a></li>
									<li><a href="archvie">Text 305</a></li>
								</ul>
								<ul class="list-unstyled">
									<li><a href="archvie">Text 306</a></li>
									<li><a href="archvie">Text 307</a></li>
									<li><a href="archvie">Text 308</a></li>
									<li><a href="archvie">Text 309</a></li>
									<li><a href="archvie">Text 310</a></li>
								</ul>
								<ul class="list-unstyled">
									<li><a href="archvie">Text 311</a></li>
									<li><a href="archvie">Text 312</a></li>
									<li><a href="archvie#">Text 313</a></li>
									<li><a href="archvie#">Text 314</a></li>
									<li><a href="archvie">Text 315</a></li>
								</ul>
							</div>
						</div>
					</li>
					<li><a href="archvie"><i class="fa fa-cubes"></i> Blocks</a></li>
