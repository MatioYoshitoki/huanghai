					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Account</a>
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul id="account" class="list-unstyled">
									<li><a onclick="test()">Login</a></li>
						...
						<div class="dropdown-menu">
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<li><a href="archive">Upload Video</a></li>
									<li><a href="archive">Manage Video</a></li>
								</ul>
							</div> 
						</div>
					</li>
...
<!-- Header -->
	...
	<!-- Footer -->
	<div id="loginDiv" style="width: 500px; background: #dcd4d4; display: none; border-radius: 10px; padding: 20px;">
		...
		<button onclick="login()" name="Login" value="Login" class="submit_btn" style="margin: 0 auto; display: block; height: 40px;">Login</button>
	</div>
	...
	<script>
		window.onload = function(){
			...
			if (getCookie("isLogin")=="0" || getCookie("isLogin")==""){
				if (getCookie("session_id")!="") {
					console.log(getCookie("session_id"));
					//				var data = {session_id:getCookie("session_id")};
					$.ajax({
						cache: true,
						type: "POST",
						url: "/autoLog",
						...
						success: function (data) {
							...
							if (json.status == "0") {
								...
								document.cookie = "user_name=" + json.user_name;
								document.cookie = "user_icon=" + json.user_icon;
								document.cookie = "user_level=" + json.user_authority;


								account_list.innerHTML =
										"<li><a href=\"login\">" + json.user_name + "</a></li>\n" +
								...
								account_list.innerHTML = "<li><a href='javascript:;' onclick='test()'>Login</a></li>\n"+
														"<li><a href=\"regist\">Register</a></li>"
								easyDialog.open({
									container: {
										content: json.info
				...
				account_list.innerHTML =
						"<li><a href='javascript:;' onclick='test()'>" + getCookie("user_name") + "</a></li>\n" +
						"<li><a href='javascript:;' onclick='logout()'>Log out</a></li>";
			}
		};
